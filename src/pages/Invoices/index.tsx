    ...
    <>
      ...
      <Container className="mx-5 mb-10 overflow-hidden rounded-lg bg-violet-200/10 p-0 text-center md:mx-3 lg:mx-auto">
        <form className="w-full">
          <Container className="mx-5 mb-10 flex w-full  items-start rounded-lg p-0 text-center md:mx-3 lg:mx-auto">
            <NumberInput
              hideControls
              ...
              >
                ...
                <div className="flex items-center justify-around border-t border-gray-300 p-4 text-center text-gray-600">
                  ...
                  <p className="">
                    ...
                    <span className="block font-bold text-gray-900">{2}</span>
                  </p>
                </div>
              </div>
            </Grid.Col>
      ...
      <Container className="!my-10 mx-5 flex items-center justify-center overflow-hidden rounded-lg bg-violet-200/10 p-0 py-5 text-center md:mx-3 lg:mx-auto">
